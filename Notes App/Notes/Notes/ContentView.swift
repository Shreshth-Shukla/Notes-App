...
//  Notes
//
//  Created by Shreshth Shalini Shukla on 28/03/23.
//
...
struct ContentView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationBarItems(leading: Button(action: {
                ...
                Text("Add")
            }).sheet(isPresented: $showAdd, onDismiss: fetchNote, content: {
                if (self.isEditMode == .inactive){
                    AddNoteView()
                }
                else{
    ...
    func fetchNote() {
        ...
        let url = URL(string: "http://localhost:1000/notes")!
    ...
    func deleteNote() {
        ...
        let url = URL(string: "http://localhost:1000/notes/\(id)")!
